...
'''
package_dict["UBOX_SINGLE_75"] = [['ubox_single_75', 'VESC_UBOX_SINGLE_75_FW6.05.bin'],
                                  ['ubox_single_75_no_limits', 'VESC_UBOX_SINGLE_75_FW6.05_NO_LIMITS.bin']]
package_dict["UBOX_V1_75_MICRO"] = [['ubox_v1_75_micro', 'VESC_UBOX_V1_75_MICRO_FW6.05.bin'],
                                    ['ubox_v1_75_micro_no_limits', 'VESC_UBOX_V1_75_MICRO_FW6.05_NO_LIMITS.bin']]
package_dict["UBOX_V1_75_TYPEC"] = [['ubox_v1_75_typec', 'VESC_UBOX_V1_75_TYPEC_FW6.05.bin'],
                                    ['ubox_v1_75_typec_no_limits', 'VESC_UBOX_V1_75_TYPEC_FW6.05_NO_LIMITS.bin']]
package_dict["UBOX_V2_75"] = [['ubox_v2_75', 'VESC_UBOX_V2_75_FW6.05.bin'],
                              ['ubox_v2_75_no_limits', 'VESC_UBOX_V2_75_FW6.05_NO_LIMITS.bin']]
package_dict["UBOX_SINGLE_100"] = [['ubox_single_100', 'VESC_UBOX_SINGLE_100_FW6.05.bin'],
                                   ['ubox_single_100_no_limits', 'VESC_UBOX_SINGLE_100_FW6.05_NO_LIMITS.bin']]
package_dict["UBOX_SINGLE_80"] = [['ubox_single_80', 'VESC_UBOX_SINGLE_80_FW6.05.bin'],
                                  ['ubox_single_80_no_limits', 'VESC_UBOX_SINGLE_80_FW6.05_NO_LIMITS.bin']]
package_dict["UBOX_SINGLE_85_200"] = [['ubox_single_85_200', 'VESC_UBOX_SINGLE_85_200_FW6.05.bin'],
                                      ['ubox_single_85_200_no_limits', 'VESC_UBOX_SINGLE_85_200_FW6.05_NO_LIMITS.bin']]
package_dict["UBOX_V2_100"] = [['ubox_v2_100', 'VESC_UBOX_V2_100_FW6.05.bin'],
                               ['ubox_v2_100_no_limits', 'VESC_UBOX_V2_100_FW6.05_NO_LIMITS.bin']]
package_dict["UBOX_126_100"] = [['ubox_126_100', 'VESC_UBOX_126_100_FW6.05.bin'],
                               ['ubox_126_100_no_limits', 'VESC_UBOX_126_100_FW6.05_NO_LIMITS.bin']]
package_dict["UBOX_126_160"] = [['ubox_126_160', 'VESC_UBOX_126_160_FW6.05.bin'],
                               ['ubox_126_160_no_limits', 'VESC_UBOX_126_160_FW6.05_NO_LIMITS.bin']]
'''
