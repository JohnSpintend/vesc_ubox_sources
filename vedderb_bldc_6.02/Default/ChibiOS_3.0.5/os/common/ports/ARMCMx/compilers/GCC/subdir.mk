...
ChibiOS_3.0.5/os/common/ports/ARMCMx/compilers/GCC/%.o: ../ChibiOS_3.0.5/os/common/ports/ARMCMx/compilers/GCC/%.s
	@echo 'Building file: $<'
...
ChibiOS_3.0.5/os/common/ports/ARMCMx/compilers/GCC/%.o: ../ChibiOS_3.0.5/os/common/ports/ARMCMx/compilers/GCC/%.c
	@echo 'Building file: $<'
